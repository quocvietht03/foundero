<?php
/* Count post view. */
if (!function_exists('foundero_set_count_view')) {
  function foundero_set_count_view()
  {
    $post_id = get_the_ID();

    if (is_single() && !empty($post_id) && !isset($_COOKIE['foundero_post_view_' . $post_id])) {
      ...
      /* set cookie. */
      setcookie('foundero_post_view_' . $post_id, $post_id, time() * 20, '/');
    }
  }
}
add_action('wp', 'foundero_set_count_view');

/* Post count view */
if (!function_exists('foundero_get_count_view')) {
  function foundero_get_count_view()
  {
    $post_id = get_the_ID();
    $views = get_post_meta($post_id, '_post_count_views', true);

    $views = $views ? $views : 0;
    $label = $views > 1 ? esc_html__('Views', 'foundero') : esc_html__('View', 'foundero');
    return $views . ' ' . $label;
  }
}

/* Post Reading */
if (!function_exists('foundero_reading_time_render')) {
  function foundero_reading_time_render()
  {
...
/* Single Post Title */
if (!function_exists('foundero_single_post_title_render')) {
  function foundero_single_post_title_render()
  {
    ob_start();
?>
...
/* Post Title */
if (!function_exists('foundero_post_title_render')) {
  function foundero_post_title_render()
  {
    ob_start();
  ?>
    <h3 class="bt-post--title">
...
/* Post Featured */
if (!function_exists('foundero_post_featured_render')) {
  function foundero_post_featured_render($image_size = 'full')
  {
    ob_start();
...
/* Post Cover Featured */
if (!function_exists('foundero_post_cover_featured_render')) {
  function foundero_post_cover_featured_render($image_size = 'full')
  {
    ob_start();
    ?>
    <div class="bt-post--featured">
...
/* Post Publish */
if (!function_exists('foundero_post_publish_render')) {
  function foundero_post_publish_render($format = null)
  {
    ob_start();
    if ($format) {
...
/* Post Short Meta */
if (!function_exists('foundero_post_short_meta_render')) {
  function foundero_post_short_meta_render()
  {
    ob_start();
  ...
  ?>
    <div class="bt-post--meta">
      ...
      echo foundero_reading_time_render();
      ?>
    </div>
  <?php
...
/* Post Meta */
if (!function_exists('foundero_post_meta_render')) {
  function foundero_post_meta_render()
  {
    ob_start();
    $post_id = get_the_ID();
...
if (!function_exists('foundero_post_meta_single_render')) {
  function foundero_post_meta_single_render()
  {
    ob_start();
    ...
    <ul class="bt-post--meta">
      ...
      <li class="bt-meta bt-meta--author">
        <a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>">
          ...
          <?php echo esc_html__('By', 'foundero') . ' ' . get_the_author(); ?>
        </a>
      </li>
    </ul>
    <?php
...
/* Post Category */
if (!function_exists('foundero_post_category_render')) {
  function foundero_post_category_render()
  {
    $post_id = get_the_ID();
...
/* Post Excerpt */
if (!function_exists('foundero_post_excerpt_render')) {
  function foundero_post_excerpt_render()
  {
    ob_start();
    ?>
...
/* Post Content */
if (!function_exists('foundero_post_content_render')) {
  function foundero_post_content_render()
  {
    ob_start();
    if (is_single()) {
    ?>
      <div class="bt-post--content">
        ...
        the_content();
        wp_link_pages(array(
          'before' => '<div class="page-links">' . esc_html__('Pages:', 'foundero'),
          'after' => '</div>',
        ));
        ?>
      </div>
...
/* Post tag */
if (!function_exists('foundero_tags_render')) {
  function foundero_tags_render()
  {
    ob_start();
    if (has_tag()) {
    ?>
      <div class="bt-post-tags">
        <span><?php esc_html_e('Tag:', 'foundero') ?></span>
        <?php
        if (has_tag()) {
          the_tags('', '', '');
        }
...
/* Post share */
if (!function_exists('foundero_share_render')) {
  function foundero_share_render()
  {

    $social_item = array();

    $social_item[] = '<li>
                        <a target="_blank" data-btIcon="fa fa-facebook" data-toggle="tooltip" title="' . esc_attr__('Facebook', 'foundero') . '" href="https://www.facebook.com/sharer/sharer.php?u=' . get_the_permalink() . '">
                       <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
    ...
    $social_item[] = '<li>
                      <a target="_blank" data-btIcon="fa fa-twitter" data-toggle="tooltip" title="' . esc_attr__('Twitter', 'foundero') . '" href="https://twitter.com/share?url=' . get_the_permalink() . '">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
    ...
    $social_item[] = '<li>
                    <a target="_blank" data-btIcon="fa fa-instagram" data-toggle="tooltip" title="' . esc_attr__('Instagram', 'foundero') . '" href="https://www.instagram.com/sharer.php?u=' . get_the_permalink() . '">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
    ...
    $social_item[] = '<li>
                        <a target="_blank" data-btIcon="fa fa-pinterest" data-toggle="tooltip" title="' . esc_attr__('Pinterest', 'foundero') . '" href="https://pinterest.com/pin/create/button/?url=' . get_the_permalink() . '&media=' . wp_get_attachment_url(get_post_thumbnail_id()) . '&description=' . get_the_title() . '">
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
    ...
    if (is_singular('post') && has_tag()) { ?>
      <div class="bt-post-share">
        <?php if (!empty($social_item)) {
          echo '<span>' . esc_html__('Share this post: ', 'foundero') . '</span><ul>' . implode(' ', $social_item) . '</ul>';
        } ?>
      </div>
    ...
    <?php } elseif (!empty($social_item)) { ?>
      ...
      <div class="bt-post-share">
        <span><?php echo esc_html__('Share: ', 'foundero'); ?></span>
...
/* Post Button */
if (!function_exists('foundero_post_button_render')) {
  function foundero_post_button_render($text)
  { ?>
...
/* Author Icon */
if (!function_exists('foundero_author_icon_render')) {
  function foundero_author_icon_render()
  { ?>
    <div class="bt-post-author-icon">
      ...
      <h4 class="bt-post-author-icon--name"> <?php echo esc_html__('By', 'foundero') . ' ' . get_the_author(); ?> </h4>
    </div>
  <?php }
}
/* Author with avatar */
if (!function_exists('foundero_author_w_avatar')) {
  function foundero_author_w_avatar()
  {
  ...
  ?>
    <div class="bt-post-author-w-avatar">
      ...
      <h4 class="bt-post-author-w-avatar--name"> <span><?php echo esc_html__('By ', 'foundero') ?></span>
...
/* Author */
if (!function_exists('foundero_author_render')) {
  function foundero_author_render()
  {
    $author_id = get_the_author_meta('ID');
...
/* Related posts */
if (!function_exists('foundero_related_posts')) {
  function foundero_related_posts()
  {
    if (function_exists('get_field')) {
      ...
      $related_posts = array(
        'heading' => __('Related Articles', 'foundero'),
        'description' => __('Discover the Hottest Fashion News and Trends Straight from the Runway', 'foundero'),
        'number_posts' => 3,
      );
    }
...
//Comment Field Order
function foundero_comment_fields_custom_order($fields)
{
...
add_filter('comment_form_fields', 'foundero_comment_fields_custom_order');

/* Custom comment list */
if (!function_exists('foundero_custom_comment')) {
  function foundero_custom_comment($comment, $args, $depth)
  {
      ...
      <div class="bt-comment">
        ...
        <div class="bt-author">
          ...
          <?php if ($comment->comment_approved == '0') : ?>
            <em class="comment-awaiting-moderation"><?php esc_html_e('Your comment is awaiting moderation.', 'foundero'); ?></em>
          <?php endif; ?>
        </div>
