...
<article <?php post_class('bt-post'); ?>>
  ...
  <?php echo foundero_post_cover_featured_render('medium_large'); ?>
    <div class="bt-post--content">
      ...
      <?php echo foundero_post_title_render(); ?>
    </div>
    <div class="bt-post--info">
        <?php
        echo foundero_post_publish_render();
        echo foundero_author_icon_render();
        ?>
      </div>
  </div>
</article>