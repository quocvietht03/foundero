<?php
function foundero_register_layout_category($categories)
{
...
add_filter('block_categories_all', 'foundero_register_layout_category');

function foundero_acf_init()
{
    ...
    if (function_exists('acf_register_block')) {
        acf_register_block(array(
            ...
            'title'             => __('Widget - Recent Posts', 'foundero'),
            'description'       => __('Widget - Recent Posts block.', 'foundero'),
            'render_callback'   => 'foundero_acf_block_render_callback',
            // 'enqueue_assets' => 'foundero_acf_block_assets_callback',
...
add_action('acf/init', 'foundero_acf_init');

function foundero_acf_block_render_callback($block)
{
...
function foundero_acf_block_assets_callback($block)
{
