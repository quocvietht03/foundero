...
namespace FounderoElementorWidgets\Widgets\FounderoSiteInformation;

use Elementor\Widget_Base;
use Elementor\Controls_Manager;
use Elementor\Group_Control_Typography;

class Widget_FounderoSiteInformation extends Widget_Base
{
	...
	{
		return __('Site Information', 'foundero');
	}
	...
	protected function register_content_section_controls()
	{
		...
		$this->add_control(
			'list',
			[
				'label' => esc_html__('Show Elements', 'foundero'),
				'type' => Controls_Manager::SELECT2,
				'label_block' => true,
				'multiple' => true,
				'options' => [
					'phone'  => esc_html__('Phone', 'foundero'),
					'address' => esc_html__('Address', 'foundero'),
					'email' => esc_html__('Email', 'foundero'),
				],
				'default' => ['phone', 'email'],
			]
		);
		$this->add_control(
			'title_phone',
			[
				'label' => esc_html__('Title Phone', 'foundero'),
		...
		$this->add_control(
			'title_address',
			[
				'label' => esc_html__('Title Address', 'foundero'),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
			]
		);
		$this->add_control(
			'title_email',
			[
				'label' => esc_html__('Title Email', 'foundero'),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
			]
		);
	...
	protected function register_layout_section_controls()
	{
		...
		$this->add_control(
			'style',
			[
				'label' => esc_html__('Layout Style', 'foundero'),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'column' => [
						'title' => esc_html__('Block', 'foundero'),
						'icon' => 'eicon-editor-list-ul',
					],
					'row' => [
						'title' => esc_html__('Inline', 'foundero'),
		...
		$this->add_responsive_control(
			'column_gap',
			[
				'label' => __('Space Between', 'foundero'),
		...
		$this->add_responsive_control(
			'separator',
			[
				'label'    => __('Separator', 'foundero'),
				'type'     => Controls_Manager::SWITCHER,
				'label_on' => __('Show', 'foundero'),
				'label_off' => __('Hide', 'foundero'),
				'default'  => '',
				'condition' => [
					'style' => 'row',
				],
