...
namespace FounderoElementorWidgets\Widgets\FounderoMobileMenu;

use Elementor\Widget_Base;
use Elementor\Controls_Manager;
use Elementor\Group_Control_Typography;

class Widget_FounderoMobileMenu extends Widget_Base
{
	...
	{
		return __('Mobile Menu', 'foundero');
	}
	...
	protected function register_content_section_controls()
	{
		...
		if ( ! empty( $menus ) ) {
			$this->add_control(
				'menu',
				[
					'label' => esc_html__( 'Menu', 'foundero' ),
					...
					'description' => sprintf(
						...
						esc_html__( 'Go to the %1$sMenus screen%2$s to manage your menus.', 'foundero' ),
			...
			$this->add_control(
				...
				[
					...
					'alert_type' => 'info',
					'heading' => esc_html__( 'There are no menus in your site.', 'foundero' ),
					'content' => sprintf(
						/* translators: 1: Link opening tag, 2: Link closing tag. */
						esc_html__( 'Go to the %1$sMenus screen%2$s to create one.', 'foundero' ),
	...
	protected function register_style_content_section_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Main Menu', 'foundero'),
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'Active', 'foundero' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Vertical Padding', 'foundero' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Toggle Offset', 'foundero' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', 'custom' ],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Sub Menu', 'foundero'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Additional Options', 'foundero'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'heading_toggle_menu',
			[
				'label' => esc_html__( 'Toggle Menu', 'foundero' ),
		...
		$this->add_control(
			'color_toggle_menu',
			[
				'label' => esc_html__( 'Color', 'foundero' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Divider Menu', 'foundero' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'divider_menu_style',
			[
				'label' => esc_html__( 'Style', 'foundero' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'none' => esc_html__( 'None', 'foundero' ),
					'solid' => esc_html__( 'Solid', 'foundero' ),
					'double' => esc_html__( 'Double', 'foundero' ),
					'dotted' => esc_html__( 'Dotted', 'foundero' ),
					'dashed' => esc_html__( 'Dashed', 'foundero' ),
				],
				'default' => 'solid',
				'selectors' => [
		...
		$this->add_control(
			'divider_menu_weight',
			[
				'label' => esc_html__( 'Width', 'foundero' ),
				'type' => Controls_Manager::SLIDER,
